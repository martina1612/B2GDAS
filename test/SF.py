...
SF_mu = ttbar_mu_eff/data_mu_eff
SF_el = ttbar_el_eff/data_el_eff
SF_mu_err = div_err(ttbar_mu_eff, ttbar_mu_eff_err, data_mu_eff, data_mu_eff_err)
SF_el_err = div_err(ttbar_el_eff, ttbar_el_eff_err, data_el_eff, data_el_eff_err)
